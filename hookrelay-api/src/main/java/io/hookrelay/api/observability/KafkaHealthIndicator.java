 ...
 * the cluster with a short timeout — if that doesn't come back, ingestion
 * publish and dispatcher consumption are both about to fail, which is
 * exactly what a readiness check should report.
 */
@Component
